    ...
    if (selectedDates[0] - options.defaultDate > 0) {
      ...
      startBtn.addEventListener('click', () => {
        ...
        Notiflix.Notify.success(
          'Date successfully selected.Commencing the countdown'
        );
        ...
        setInterval(() => {
          ...
          if (diff >= 0) {
            ...
            (dayVl.textContent = days),
              (hourVl.textContent = hours),
              (minVl.textContent = minutes),
              (secVl.textContent = seconds);
          } else {
